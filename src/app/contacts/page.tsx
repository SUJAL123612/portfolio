      ...
      <div className="bg-black/90 border border-transparent w-full h-[400px] py-16 px-4">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center bg-gray-900 rounded-lg p-6 shadow-lg hover:shadow-purple-600 transition duration-300">
            <img src="email_icon.png" alt="Email" className="w-12 h-12 mb-4 transition-transform duration-500 hover:scale-110" />
          ...
          {/* LinkedIn Card */}
          <div className="flex flex-col items-center bg-gray-900 rounded-lg p-6 shadow-lg hover:shadow-purple-600 transition duration-300">
            <img src="linkedin_icon.png" alt="LinkedIn" className="w-12 h-12 mb-4 transition-transform duration-500 hover:scale-110" />
          ...
          {/* GitHub Card */}
          <div className="flex flex-col items-center bg-gray-900 rounded-lg p-6 shadow-lg hover:shadow-purple-600 transition duration-300">
            <img src="github_icon.png" alt="GitHub" className="w-12 h-12 mb-4 transition-transform duration-500 hover:scale-110" />
