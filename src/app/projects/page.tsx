...
export default function Projects() {
    return (
        <>
            <div className="bg-black/90 border border-transparent w-full h-[1400px]">
                <h2
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[400px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <a href="https://sujal123612.github.io/restaurent/">Restaurant</a>
                    </p>
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[400px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/simple_calc/">Calculator</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[400px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/Tic-Tac-Toe/">Tic-Tac-Toe</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[380px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/Expense_Tracker/">Expense_Tracker</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[380px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/Shopping_List/">Shopping_List</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[380px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/Api_Random_User/">API_Random_User</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[380px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/Weather_APP/">Weather_App</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
                ...
                <div className="rounded-lg border border-white mt-[60px] w-[400px] h-[380px] ml-[20px] p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-2xl text-white font-sans cursor-pointer mb-2 hover:text-gray-400">
                    <a href="https://sujal123612.github.io/Github_Profile_search/">Github_Profile_Search</a>
                    </p>
                    <p className="text-1xl text-white/60 font-sans cursor-pointer">
